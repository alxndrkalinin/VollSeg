    ...
    def Train(self):
        ...
        if self.train_star:
            ...
            if self.load_data_sequence == False:
                ...
                self.X = [
                    normalize(DownsampleData(x, self.downsample_factor), 1, 99.8, axis=self.axis_norm)
            ...
            print(
                ...
                os.path.exists(self.model_dir + self.model_name + "/" + "weights_now.h5"),
            )
            ...
            historyStar = Starmodel.train(
                self.X_trn, self.Y_trn, validation_data=(self.X_val, self.Y_val), epochs=self.epochs
            )
            ...
            plot_history(
                historyStar,
                ["loss", "val_loss"],
                ["dist_relevant_mae", "val_dist_relevant_mae", "dist_relevant_mse", "val_dist_relevant_mse"],
            )
