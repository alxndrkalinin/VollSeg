    ...
    def Train(self):
        ...
        if self.train_unet:
            ...
            if self.copy_model_dir is not None:
                if (
                    os.path.exists(self.copy_model_dir + "UNET" + self.copy_model_name + "/" + "weights_now.h5")
                    and os.path.exists(self.model_dir + "UNET" + self.model_name + "/" + "weights_now.h5") == False
                ):
