...
class SpatialImage(np.ndarray):
    ...
    def __new__(cls, input_array, voxelsize=None, vdim=None, info=None, dtype=None, **kwargs):
    ...
    def valid_array(cls, array_like):
        return isinstance(array_like, (np.ndarray, cls)) and array_like.flags.f_contiguous
